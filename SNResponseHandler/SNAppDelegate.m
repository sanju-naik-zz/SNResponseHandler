...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    [Parse setApplicationId:@"uDnyIMdssbmDRnDo8npOiKgocrtSCKV1bIWnUGRG"
                  clientKey:@"jW4ThD5vrGNyeebJJPVd3KaKEHurvMSnNpgHbKDY"];
...
- (void)sessionStateChanged:(FBSession *)session state:(FBSessionState) state error:(NSError *)error
{
    ...
    {
        if([_delegate respondsToSelector:@selector(sessionSuccess)])
        {
            [_delegate sessionSuccess];
        }
        return;
    }
    else if (!error && state == FBSessionStateOpenTokenExtended)
    {
